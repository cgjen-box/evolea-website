...
This document defines test cases for EVOLEA website. Execute these using Chrome DevTools MCP tools.
...
## EVOLEA Website (localhost:4321 / evolea.ch)

### EV-001: Homepage Hero
**Steps:** Navigate to `/`, verify hero loads with gradient and CTA
**Expected:** Prism gradient hero displays, "Anmeldung" CTA button visible

### EV-002: Programs Page
**Steps:** Navigate to `/programme`, verify program cards display
**Expected:** Mini Garten, Mini Projekte, Mini Turnen cards render with images

### EV-003: Individual Program Pages
**Steps:** Navigate to `/programme/mini-garten`, `/programme/mini-projekte`, etc.
**Expected:** Program details load with schedule, pricing, description

### EV-004: About Page
**Steps:** Navigate to `/ueber-uns`, verify team and mission sections
**Expected:** Team photos display, content renders correctly

### EV-005: Contact Form
**Steps:** Navigate to `/kontakt`, fill and submit form
**Expected:** Form validates inputs, submits to Formspree, shows success

### EV-006: Navigation
**Steps:** Test desktop and mobile navigation
**Expected:** Desktop nav expands, mobile hamburger menu works with solid background

### EV-007: Language Switching
**Steps:** Switch between DE and EN languages
**Expected:** URL changes to /en/ prefix, content updates to English
