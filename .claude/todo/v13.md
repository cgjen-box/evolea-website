...
• Mini Turnen: Bewegung und Spass einmal pro Woche

Unsere Angebote werden in Zukunft stets erweitert.
```

**Important:** Do NOT include the sentence about "Als Trägerschaft fungiert der EVOLEA Verein..." — this should be removed.
...
## Issue 24: Simplify Homepage Footer Contact Area

**Priority:** High  
**Location:** Homepage → Section before footer

### 24a: Remove "Kontakt" Section

**What to remove:** The entire "Kontakt" section containing:
- "Kontakt" heading
- "Wir freuen uns auf den Austausch mit Euch." text
- "hello@evolea.ch" email button
- "Instagram" button

### 24b: Add Instagram Button to Final CTA Section

**Location:** "Bereit für den nächsten Schritt?" section

**Action:** Add the Instagram button (with gradient styling) next to or below the existing "Jetzt Kontakt aufnehmen" button.

**Result:** The final CTA section should have:
- "Bereit für den nächsten Schritt?" heading
- "Wir freuen uns darauf, Sie und Ihr Kind kennenzulernen." text
- "Jetzt Kontakt aufnehmen" button
- "Instagram" button (gradient orange/coral style)
...
- [ ] **#24a:** Remove "Kontakt" section (with email + Instagram buttons)
- [ ] **#24b:** Add Instagram button to "Bereit für den nächsten Schritt?" section
