...
## MCP Server (Codex Desktop / Codex App)

The image generation system is available as an MCP server for use with Codex Desktop and Codex App.
...
### Quick Commands in Codex Desktop
...
### Fully Automated (with Codex selection)
...
| File | Purpose |
|------|---------|
| `scripts/mcp_image_server.py` | MCP server for Codex Desktop |
...
- `.Codex/skills/Design skills/illustrations.md` - Illustration guidelines
